          ...
          <div className="text-center">
            ...
            <div className="relative mx-auto max-w-5xl">
              <div className="relative rounded-2xl bg-white/60 backdrop-blur-xl border border-border/50 shadow-2xl p-6">
                ...
                {/* Floating Elements */}
                <div className="absolute -left-4 top-1/4 bg-white rounded-xl border border-border/50 shadow-lg p-3 hidden lg:block">
                  <div className="flex items-center gap-2">
                ...
                <div className="absolute -right-4 top-1/3 bg-white rounded-xl border border-border/50 shadow-lg p-3 hidden lg:block">
                  <div className="flex items-center gap-2">
